...
#tar xzvf project1/build_crosscompile/overlay_ws.tar.gz
#tar xzvf project1/build_crosscompile/catkin_ws.tar.gz
...
#rm -rf project1/build_crosscompile/overlay_ws
#rm -rf project1/build_crosscompile/catkin_ws
